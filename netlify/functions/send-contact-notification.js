// netlify/functions/send-contact-notification.js - FIXED VERSION
async function sendLoopsEmail({ transactionalId, email, variables }) {
  try {
    ...
    console.log(`Sending contact notification to ${email}`);
...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    await sendLoopsEmail({
      ...
      email: 'info@mywaterquality.ca', // Changed from 'to' to 'email'
      variables: {
